...
$.getJSON("./media/data-spasial/jembatan_pt.geojson", function (OBJECTID) { 
    L.geoJSON(OBJECTID, { 
...
$.getJSON("./media/data-spasial/admin_kelurahan_ln.geojson", function (OBJECTID) { 
L.geoJSON(OBJECTID, { 
style: { 
color : "black", 
weight : 2, 
...
$.getJSON("./media/data-spasial/landcover_ar.geojson", function (REMARK) { 
L.geoJson(REMARK, { 
